...
ALTER TABLE TMECANICOS DROP CONSTRAINT UNIQUE_DNI;
...
DELETE FROM TSUSTITUCIONES WHERE INTERVENCION_AVERIA_ID >= 0 AND INTERVENCION_AVERIA_ID <= 10;
DELETE FROM TINTERVENCIONES WHERE AVERIA_ID >= 0 AND AVERIA_ID <= 10;

UPDATE TAVERIAS SET (DESCRIPCION,FECHA,IMPORTE,STATUS,VEHICULO_ID) = ('Aire acondicionado', '2018-09-05', 80, 'ABIERTA',11) where id=1;
UPDATE TAVERIAS SET (DESCRIPCION,FECHA,IMPORTE,STATUS,VEHICULO_ID) = ('Motor', '2018-09-15', 1500, 'ABIERTA', 12) where id=2;
UPDATE TAVERIAS SET (DESCRIPCION,FECHA,IMPORTE,STATUS,VEHICULO_ID) = ('Junta de una culata', '2018-09-30', 400, 'ABIERTA', 15) where id=3;
UPDATE TAVERIAS SET (DESCRIPCION,FECHA,IMPORTE,STATUS,VEHICULO_ID) = ('Luna rota', '2018-10-01', 100, 'ABIERTA', 20) where id=4;
UPDATE TAVERIAS SET (DESCRIPCION,FECHA,IMPORTE,STATUS,VEHICULO_ID) = ('Cambio de defensa', '2018-09-10', 1000, 'ABIERTA', 25) where id=5;
UPDATE TAVERIAS SET (DESCRIPCION,FECHA,IMPORTE,STATUS,VEHICULO_ID) = ('Cambio de frenos', '2018-09-19', 250, 'ABIERTA', 11) where id=6;
