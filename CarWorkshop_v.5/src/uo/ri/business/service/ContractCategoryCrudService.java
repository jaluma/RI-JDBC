...
public interface ContractCategoryCrudService {
	 ...
	 * 
	 * @param dto,
	 *            the id value, if any, will be ignored
	 * @throws BusinessException
	 *             if: - another category with the same name already exists, or -
	 *             triennium salary is negative, or - productivity plus is negative
	 */
	 ...
	 *            of the category
	 * @throws BusinessException
	 *             if: - the category does not exist, or - the category has
	 *             contracts assigned
	 */
	 ...
	 * 
	 * @param dto,
	 *            only id, trienniumSalary and productivitySalary fields are useful
	 *            for this operation, the rest will be ignored
	 * @throws BusinessException
	 *             if: - the category does not exist, or - the new trienniumSalary
	 *             is negative, or - the new productivitySalary is negative
	 */
